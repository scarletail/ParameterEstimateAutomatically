...
#include "ne_ds.h"
#include "RC1_Manual_c7e1c277_1_ds_dxy.h"
...
int32_T RC1_Manual_c7e1c277_1_ds_dxy(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t8, NeDsMethodOutput *t9)
{
  ...
  out.mX[0] = -1.0;
  out.mX[1] = -8.960573476702509E-6;
  out.mX[2] = -(-(-(-(-(-U_idx_0 * (b_efOut[0] * -8.960573476702509E-6))))));
  out.mX[3] = 1.0;
  (void)sys;
  (void)t9;
  return 0;
