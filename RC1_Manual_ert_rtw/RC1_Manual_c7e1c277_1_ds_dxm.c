...
#include "ne_ds.h"
#include "RC1_Manual_c7e1c277_1_ds_dxm.h"
...
int32_T RC1_Manual_c7e1c277_1_ds_dxm(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t8, NeDsMethodOutput *t9)
{
  ...
  out.mX[0] = -(b_efOut[0] * -8.960573476702509E-6) * 0.0029170084447674507;
  (void)sys;
  (void)t9;
  return 0;
}
