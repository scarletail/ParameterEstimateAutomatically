...
#include "ne_ds.h"
#include "RC1_Manual_c7e1c277_1_ds_y.h"
...
int32_T RC1_Manual_c7e1c277_1_ds_y(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t11, NeDsMethodOutput *t12)
{
  ...
  out.mX[0] = X_idx_1;
  out.mX[1] = -((-(-U_idx_0 * b_efOut[0]) / -1.0 - (-X_idx_0 + X_idx_2)) / -1.0)
    / -1.0;
  (void)sys;
  (void)t12;
  return 0;
